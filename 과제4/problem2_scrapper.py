...
tags = soup.select_one('#yDmH0d > div:nth-child(1) > div > div:nth-child(2) > div.QZ3zWd > div > div.UtePc.RCETm.SwuGbc')
...
df = pd.DataFrame(dataList,columns=['name', 'job_role', 'start_year', 'end_year', 'interest_role', 'profile_pic_url'])
